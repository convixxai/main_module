 ...
 * `_activeBcp47` accepted but unused - kept so exotel-voicebot.ts's newer 3-arg call sites
 * (untouched by this rollback) still compile; this Sept-15 version doesn't localize by
 * active language, matching that day's actual behavior.
 */
